...
fm_command="xterm"    # Defualt file manager/terminal
dmenu_options=" -i -nb #000000 -nf #ffffff -sb #002255 -sf #ffffff -fn xft:style=bold:pixelsize=16"    # Dmenu settings; See man dmenu for more info
